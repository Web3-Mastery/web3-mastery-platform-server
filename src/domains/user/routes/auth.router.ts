...
import preSignUpAuthAndSessionsMiddleware from '../../../middlewares/preSignUpAuthAndSessionsMiddleware.js';
...
router
  ...
  .post(validateData({ body: preSignUpSchema }), preSignUpAuthAndSessionsMiddleware, verifySignUpInitialization);
router.route('/complete-sign-up').post(validateData({ body: userSchema }), preSignUpAuthAndSessionsMiddleware, completeSignUp);
