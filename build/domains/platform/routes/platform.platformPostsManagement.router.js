...
router
    ...
    .patch(authAndSessionsMiddleware, validateData({ body: postSchema, params: paramsSchema }), verifyAdminMiddleware, verifyUserDataToControllerMiddleware, updatePlatformPost);
router
    .route('/delete-post/:postId')
    .delete(authAndSessionsMiddleware, validateData({ body: postSchema, params: paramsSchema }), verifyAdminMiddleware, verifyUserDataToControllerMiddleware, deletePlatformPost);
