...
router
    ...
    .post(authAndSessionsMiddleware, validateData({ body: sessionActivitySchema }), verifyAdminMiddleware, verifyUserDataToControllerMiddleware, createSessionActivityController);
router
...
router
    ...
    .delete(authAndSessionsMiddleware, validateData({ params: paramsSchema }), verifyAdminMiddleware, verifyUserDataToControllerMiddleware, deletePlatformSessionActivity);
router
    .route('/get-session-activity/:activityId')
    .get(authAndSessionsMiddleware, validateData({ params: paramsSchema }), verifyAdminMiddleware, verifyUserDataToControllerMiddleware, getSessionActivity);
router
    .route('/update-session-activity/:activityId')
    .patch(authAndSessionsMiddleware, validateData({ body: sessionActivitySchema, params: paramsSchema }), verifyAdminMiddleware, verifyUserDataToControllerMiddleware, updateSessionActivityController);
