...
const completeSignUp = async (req, res) => {
    ...
    try {
        if (req.user) {
            ...
            const _preSignUpToken = preSignUpToken;
            ...
            if (preSignUpUser) {
                ...
                if (differenceInMilliseconds > twentyHoursInMilliseconds) {
                    ...
                    const { name, email, signUpStatus, secretSignUpToken, sessions } = updatedPreSignUpUser;
                    ...
                    if (preSignUpUser && newFullySignedUpUser) {
                        ...
                        const { accessToken } = tokenForFullySignedUpUser;
